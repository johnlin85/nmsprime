...
class ExtendedValidatorServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app['validator']->extend('comma_separated_hostnames_or_ips', 'Acme\Validators\ExtendedValidator@validateCommaSeparatedHostnamesOrIps');
        $this->app['validator']->extend('hostname_or_ip', 'Acme\Validators\ExtendedValidator@validateHostnameOrIp');
